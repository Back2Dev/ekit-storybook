...
const DWPInfo = () => {
  return (   
    <Box sx={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
        <Box sx={{backgroundColor:"white", width:"85%", border: "2px", borderColor: "primary", borderStyle: "solid", marginTop: "20px", paddingTop: "25px", paddingBottom: "25px"}}>
        ...
        <Box sx={{backgroundColor:"white", width:"85%", border: "2px", borderColor: "primary", borderStyle: "solid", marginTop: "20px", paddingTop: "15px", paddingBottom: "15px", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
        ...
        <List sx={{width: "85%"}}>
          <ListItem disablePadding>
            <ListItemButton sx={{display:"flex", justifyContent: "space-between", border: "2px", borderColor: "primary", borderStyle: "solid"}}>
              <ListItemText primary="Print"/>
              <ListItemIcon sx={{display:"flex", justifyContent: "center"}}><PrintOutlinedIcon color="primary" /></ListItemIcon>
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding>
            <ListItemButton sx={{display:"flex", justifyContent: "space-between", border: "2px", borderColor: "primary", borderStyle: "solid", marginTop:"15px"}}>
          ...
          <ListItem disablePadding>
            <ListItemButton sx={{display:"flex", justifyContent: "space-between", border: "2px", borderColor: "primary", borderStyle: "solid", marginTop:"15px", marginBottom: "20px"}}>
